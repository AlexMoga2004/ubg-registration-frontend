...
const RegisterPage = () => {
  ...
  const [matriculationDate, setMatriculationDate] = useState(null);
          ...
          <Grid container spacing={2}>
            <Grid item xs={6}>
              <DesktopDatePicker
                ...
                onChange={(newValue) => setMatriculationDate(newValue)}
                renderInput={(params) => (
                  <TextField
                    {...params}
                    margin="normal"
                    required
                    fullWidth
                    error={!!errors.matriculationDate}
                    helperText={errors.matriculationDate}
                  />
                )}
              />
            </Grid>
